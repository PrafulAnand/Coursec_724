...
public class Ebook_PdfViewing extends AppCompatActivity  {
...
//                container.setAlpha(0.4f);
       ...
       // Log.d("category",category);
        databaseReference = firebaseDatabase.getReference().child("Temp").child("Category").child("Ebook").child(key);
...
//                });
    ...
    OnErrorListener onErrorListener = new OnErrorListener() {
        ...
        public void onError(Throwable t) {
            setProgressVisibility(false);
            Toast.makeText(Ebook_PdfViewing.this, "Error while loading file.", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.download:
                mBuilder = new NotificationCompat.Builder(Ebook_PdfViewing.this);
    ...
    public class Downloader extends AsyncTask<String,Integer,Integer>{
        ...
        protected void onPostExecute(Integer integer) {
            ...
            mNotifyManager.notify(1,mBuilder.build());
            Toast.makeText(Ebook_PdfViewing.this, "Download Complete", Toast.LENGTH_SHORT).show();
